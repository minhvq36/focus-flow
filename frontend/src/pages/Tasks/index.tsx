...
function FocusSidebar() {
  return (
    <div className="rounded-xl border border-dashed border-border bg-card/40 p-5 flex flex-col items-center justify-center gap-3 min-h-[260px]">
      <svg viewBox="0 0 80 80" className="h-16 w-16 opacity-40" aria-hidden>
      ...
      <div className="text-center">
        <p className="text-sm font-medium text-foreground">Your garden awaits</p>
        <p className="mt-1 text-xs text-muted-foreground">
          Complete tasks to grow plants.
        </p>
      </div>
    </div>
  )
