            ...
            {notes.map((note) => (
              <div
                ...
                className={cn(
                  ...
                  !isReadOnly && 'cursor-pointer hover:border-primary/30 hover:bg-white/80 transition-colors'
                )}
              >
                <div className="flex flex-col gap-1.5">
                  {/* Truncated content — full content shown in modal */}
                  <p className="leading-relaxed text-foreground break-words text-xs line-clamp-3">
                    {note.content}
                  </p>
